...
| --- | --- | --- | --- | --- | --- | --- |
| BLK-001 | Phase 0 exact clean commit not independently verified | P0 | Open | Phase 0 | Independent verifier | `00-VERIFICATION.md` passed against exact clean commit |
...
| BLK-011 | Tracked ZIP containing `.env.local` path and generated binaries are reachable from `origin/main` and current ancestry | P0 | Open; working-tree copies removed | Phase 0 and every remote action | Repository owner/CISO/secret owners | Signed rotation assessment and approved clean-history incident closure |
