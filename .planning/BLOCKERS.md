...
| BLK-009 | Contract conformance, identity and privileged-operation gaps | P0 | Open; Generation 3 local no-bypass identity/mint/forced-issuance containment approved and planned, not yet implemented or a G5 pass | G5 | Blockchain/CISO/Legal | Plan 00-04 candidate evidence, then complete G5 and external retest |
