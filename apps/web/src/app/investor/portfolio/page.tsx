        ...
        >
          ...
          {walletAllowed ? (
            <div className="glass-surface rounded-2xl p-4 mb-6 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
              <div>
                <div className="text-sm text-muted-foreground">Onchain readiness</div>
                <div className="text-base font-semibold">Link your MetaMask to enable secondary trading and redemptions</div>
              </div>
              <WalletWidget />
            </div>
          ) : null}
