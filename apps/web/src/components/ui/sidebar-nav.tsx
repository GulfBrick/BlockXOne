      ...
      <div key={item.label}>
        {item.href ? (
          <Link
            ...
            className={`group relative flex items-center gap-3 px-4 py-2 rounded-md transition-all ${
              active
          ...
          <button
            ...
            className={`group w-full flex items-center gap-3 px-4 py-2 rounded-md transition-all text-left ${
              isExpanded
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 right-4 z-40 p-2 rounded-lg bg-bxo-surface border border-bxo-border-subtle text-bxo-text-primary"
      ...
      {/* Sidebar */}
      <nav
        className={`fixed lg:static top-0 left-0 h-screen lg:h-auto w-64 lg:w-auto bg-bxo-surface border-r border-bxo-border-subtle overflow-y-auto transition-transform duration-300 z-40 lg:z-0 ${
