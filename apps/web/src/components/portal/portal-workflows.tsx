...
import { isWealthManagerDetailsV2, subscriptionQuote, type LegacyApplicationDetails, type PortalApplication, type PortalInvestmentAccount, type PortalProduct, type PortalSnapshot } from '@/lib/portal/contracts'
