...
BlockXOne uses the exact-logo Brand System v2.0 documented in `docs/brand/v2.0/`. It combines carbon and midnight surfaces, chrome/cyan artwork, precise Archivo product typography, selective Abril Fatface display moments, STIX Two Text reading copy, and restrained illumination with the clarity required for institutional finance applications.
...
- **--bxo-carbon**: `#01070D`
- **--bxo-midnight**: `#031A28`
- **--bxo-deep-teal**: `#09354A`
- **--bxo-structural-blue**: `#115872`
- **--bxo-signal-cyan**: `#15B5D3`
- **--bxo-electric-cyan**: `#2EEFFA`
- **--bxo-ice-cyan**: `#89FAFD`
- **--bxo-steel**: `#78A4B5`
- **--bxo-chrome**: `#B6D1DA`
- **--bxo-frost**: `#EEFBFC`
...
### Application aliases
- **--bxo-bg-primary**: Carbon
- **--bxo-bg-secondary**: Midnight
- **--bxo-surface**: `rgba(7, 24, 35, 0.88)`
- **--bxo-surface-secondary**: `#081C28`
- **--bxo-surface-elevated**: Deep Teal
- **--bxo-accent-primary**: Electric Cyan
- **--bxo-accent-primary-dark**: Signal Cyan
- **--bxo-accent-primary-light**: Ice Cyan

### Semantic Colors
- **Success**: `#35E0B2` - Positive status and confirmations
- **Warning**: `#F4C95D` - Caution and warnings
- **Danger**: `#FF6680` - Errors and critical actions
- **Info**: Signal Cyan - Informational states

### Text Colors
- **--bxo-text-primary**: Frost
- **--bxo-text-secondary**: `#9CB8C4`
- **--bxo-text-tertiary**: `#6F919F`
- **--bxo-text-disabled**: `rgba(120, 164, 181, 0.56)`

### Borders & Dividers
- **--bxo-border-subtle**: `rgba(120, 164, 181, 0.18)`
- **--bxo-border-default**: `rgba(120, 164, 181, 0.24)`
- **--bxo-border-strong**: `rgba(46, 239, 250, 0.48)`
- **--bxo-divider**: `rgba(120, 164, 181, 0.14)`
...
--bxo-shadow-accent-sm: 0 4px 16px rgba(21, 181, 211, 0.12)
--bxo-shadow-accent-md: 0 12px 40px rgba(21, 181, 211, 0.16)
--bxo-shadow-accent-lg: 0 20px 64px rgba(21, 181, 211, 0.2)
```

## Typography

### Font Families
- **Product display and UI**: `Archivo` (workspace headings, body, navigation, forms)
- **Editorial display**: `Abril Fatface` (selected public headlines only)
- **Editorial reading**: `STIX Two Text` (public descriptions and long-form statements)
- **Mono**: `JetBrains Mono` (hashes, identifiers, exact figures)
